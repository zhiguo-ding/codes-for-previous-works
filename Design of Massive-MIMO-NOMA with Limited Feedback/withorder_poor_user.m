...
%%%%%%%%%%%%%%%%%%%%%% start the iteration
a1 = 5/8; a2 = 2/8; a3 = 1-a1-a2; R1=1.4; R2=1.4; R3 =2; ct=5000; 
...
%      end
 %     %%%%%%%%%%%%%%%%%%%user 2
%    pa2(k) =0;
%     p=2;xix = max((a1 - eps1*(a2+a3))/eps1,(a2 - eps1*(a3))/eps2);
%      for l = 1: p-1+1
%         i=l-1;
%         pip = factorial(Pu)/factorial(Pu-p)/factorial(p-1);
%         Fp = 1 - gammainc( real(1/snr/ai/xix), N-Mt+1);
...
semilogy(snrdb,p1,snrdb,p2,snrdb,p3,snrdb,pa3)
